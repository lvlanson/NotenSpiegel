...
// TODO	läuft aus, jqReloadCell arge verwenden
	 ...
	 * @param url
	 * @param blank 1|blank|download|null
	 */
	function jqRedirect(url,blank) 
	{
		if (blank == "download") jqDownload(url);
		else if (blank) window.open(url,'_blank');
	 ...
	 * @param blank 1|blank|download|null
	 */
	function jqRedirectVars(argc,vars,blank) 
	{
		var url;
		var extension;
		if (argc.split('?')[1] == undefined)
		...
		//var url = '/nsoft/jquery.asp?extension=' + argc.split(':')[0];
